                                ...
                                <li key={player.id} className={!player.killed ? "" : "disabledPlayer"}>
                                    {player.name}
                                    {
                                        player.roleInGame === 'don' ? <i className="fas fa-user-secret iRole"/> :
                                            player.roleInGame === 'mafia' ? <i className="fas fa-crosshairs iRole"/> :
                                                player.roleInGame === 'sheriff' ? <i className="fab fa-empire iRole"/> : null
                                    }
                                </li>
                            )
                        })}
                    ...
                    <div className="column_second">
                        ...
                        <div className="best__act">
                            <div className="gold__act">
                                ...
                                <p className="gold__act head1"><span>{playerBM.number+')'} {playerBM.name}</span> <span>{str_}</span></p>
                            </div>
                            ...
                            <div className="black__checks">
                                ...
                                <p className="black__cheks head1"><span>{sheriff.number+')'} {sheriff.name}</span>{checkArr}</p>
                            </div>
                        </div>
                    </div>
                </div>
